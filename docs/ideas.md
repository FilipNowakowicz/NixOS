1. Declarative personal workflow packs
...
3. Desktop rollback/snapshot workflow
...
6. Developer environment templates
...
7. Better Neovim as a first-class module
