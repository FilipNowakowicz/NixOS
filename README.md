...
The color system is designed to be **runtime-swappable**. Most GUI applications (Waybar, Kitty, Mako, Hyprland) source colors generated by Nix from a central theme file. This enables changing the theme on-the-fly without a full system rebuild.
...
2.  **Switch to a new theme**:
    ...
    ```
    This command updates `home/theme/active.nix`, runs `home-manager switch` to apply the changes, and reloads running applications to reflect the new theme instantly.
