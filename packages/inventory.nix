    ...
    <body>
      ...
      <script>
        ...
        function buildQuickActions() {
          ...
          packageBuild.appendChild(el("div", "signal-title", "Build homepage and data feed"));
          packageBuild.appendChild(el("code", "command", "nix build '.#packages.x86_64-linux.inventory'"));
          packageBuild.appendChild(el("code", "command", "nix build '.#packages.x86_64-linux.inventory-data'"));
